...
const MarketingPage = () => {
    ...
    <div className="flex items-center justify-center flex-col">
        <div className={cn(
            ...
            to-pink-600 text-white px-4 p-2 rounded-md pb-4 w-ft">
                work forward.
            </div>

        </div>
        <div>
        <div className={cn("text-sm md:text-xl text-neutral-400 mt-4 max-w-xs  md:max-2xl  text-center mx-auto",
         
        textFonts.className)}>
            Collaborate,manage projects,and reach new productivity
            peaks.From high rises to the home office,the way your team
             works is unique - acomplish it all with Taskify.
        </div>
